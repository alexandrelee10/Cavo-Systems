...
export const TheTeam = () => {
  return (
    // Our Team Container
    <div className="px-4 sm:px-12 lg:px-20 xl:px-40 pt-30 text-gray-800 dark:text-white">
      {/* Content Wrapper */}
      <div className="flex flex-col items-center gap-7">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 gap-5 w-full max-w-6xl">
