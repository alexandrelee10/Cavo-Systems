...
export const Navigation = ({theme, setTheme}:{theme: any, setTheme:any}) => {
    
    const [sidebarOpen, setSidebarOpen] = useState(false);
    return (
        <div className='flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 font-medium bg-white dark:bg-gray-900'>
            ...
            {/* Navigation */}
              ...
              transition-all`}>
                  ...
                  right-4
                  top-4
                  sm:hidden' onClick={()=> setSidebarOpen(false)}/>
        
                  <a href="#hero" className='sm:hover:border-b'>Home</a>
